//------------------------------------------------------------------------------
//
//  Description: Pin definitions for all MSP430 ports.
//  Maps the physical hardware to readable macros.
//
//  Ezana
//  April 2026
...
#define V_5_0              (0x02)  // 1 V_5
#define V_DAC              (0x04)  // 2 V_DAC
#define V_3_3              (0x08)  // 3 V_3.3
#define IOT_BOOT       (0x10)  // 4 IOT_BOOT_CPU
