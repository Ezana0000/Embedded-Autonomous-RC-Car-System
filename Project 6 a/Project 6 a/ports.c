...
void Init_Port1(void){
    ...
    // *** CHANGED FOR PROJECT 6: Analog Setup for Left Detector ***
    P1SEL0 |= V_DETECT_L;
    P1SEL1 |= V_DETECT_L;
    P1DIR &= ~V_DETECT_L;

    // *** CHANGED FOR PROJECT 6: Analog Setup for Right Detector ***
    P1SEL0 |= V_DETECT_R;
    P1SEL1 |= V_DETECT_R;
    P1DIR &= ~V_DETECT_R;
    ...
    // *** CHANGED FOR PROJECT 6: Analog Setup for Thumb Wheel ***
    P1SEL0 |= V_THUMB;
    P1SEL1 |= V_THUMB;
    P1DIR &= ~V_THUMB;
