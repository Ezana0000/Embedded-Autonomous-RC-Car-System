...
//
//  Description:
//  Disables watchdog and configures system clocks including DCO and XT1.
//  Sets ACLK to XT1CLK and MCLK/SMCLK to DCOCLKDIV.
//
//  Globals Used:
//  None
//
...
//------------------------------------------------------------------------------
//  Function Name: Software_Trim
//
//  Description:
//  Trims the DCO frequency by adjusting DCOFTRIM until DCOTAP is closest to 256.
//
//  Globals Used:
//  None
//
...
//
//  Local Variables:
//  oldDcoTap, newDcoTap, newDcoDelta, bestDcoDelta, csCtl0Copy, csCtl1Copy,
//  csCtl0Read, csCtl1Read, dcoFreqTrim, endLoop
//
//  Returned Value:
//  None
//------------------------------------------------------------------------------
